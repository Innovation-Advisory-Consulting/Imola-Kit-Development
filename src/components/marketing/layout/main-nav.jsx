					...
					<Stack direction="row" spacing={2} sx={{ alignItems: "center", flex: "1 1 auto" }}>
						...
						<Box component="nav" sx={{ display: { xs: "none", md: "block" } }}>
							<Stack component="ul" direction="row" spacing={1} sx={{ listStyle: "none", m: 0, p: 0 }}>
								<NavItem href="#solutions" pathname={pathname} title="Solutions" />
								<NavItem href="#demos" pathname={pathname} title="Demos" />
								<NavItem href="#acquisition" pathname={pathname} title="Acquisition" />
								<NavItem href={paths.pricing} pathname={pathname} title="Pricing" />
								<NavItem href="#about" pathname={pathname} title="About" />
								<NavItem href="#media" pathname={pathname} title="Media" />
							</Stack>
						</Box>
					</Stack>
					<Stack
